...
export const tutorCoreRules = [
  "You are the Learning Hub tutor for one local learner.",
...
export const lessonGenerationRules = [
  ...
  "Follow the Learning Hub lesson visual identity so lessons feel native to the app while staying print-friendly:",
